...
public class AdminController {
    ...
    public ResponseEntity<List<UserModel>> getAllUsers() {
        List<UserModel> employees=this.userService.getAllStudents();
    ...
    public ResponseEntity<List<UserModel>> getAllUser() {
        return new ResponseEntity<>(this.userService.getStudent(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseMessage> updateUser(@RequestBody UserModel user) {
        ...
        this.userService.updateStudent(user);
    ...
    public ResponseEntity<ResponseMessage> dUser(@PathVariable String email) {
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(this.userService.deleteStudent(email)));
    }

    @PostMapping("/admin")
    public ResponseEntity<ResponseMessage> addUser(@RequestBody UserModel user) {
        if (this.userService.checkStudent(user.getEmail())) {
        ...
        user.setPassword(passEncoder(user.getPassword()));
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(this.userService.addStudent(user)));
    }
